...
def dashboard():
    ...
    all_dashboards = [
        ...
        {"url": "https://app.powerbi.com/reportEmbedAqui está o código corrigido do `app.py`, removendo a definição duplicada da rota `/view_logs`:
...
def dashboard():
    ...
    all_dashboards = [
        {"url": "https://app.powerbi.com/view?r=eyJrIjoiMmU1MTBmYTItMmY3MS00NjYzLTg3ZWUtOWQyYzI1YTgyYTQxIiwidCI6ImNjMmE5NWVhLTMzNWMtNDQzYi04NDQzLWU5YWQzM2ZmOWUwNCJ9", "title": "Central de BIs"},
        # Outros dashboards removidos para simplicidade
    ]
